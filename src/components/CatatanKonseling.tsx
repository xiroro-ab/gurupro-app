          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            ...
            {isAdmin && (
              <select
                ...
                className="w-full sm:w-48 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-rose-500 focus:ring-1 focus:ring-rose-500"
              >
              ...
              <form id="counseling-form" onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  >
                    ...
                    {students.map(s => (
                      <option key={s.id} value={s.id}>{s.nama_siswa} ({s.nisn})</option>
                    ))}
                  </select>
                </div>
