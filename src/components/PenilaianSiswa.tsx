                      ...
                      onClick={() => {
                        ...
                        style.innerHTML = `
                          @media print {
                            ...
                            #print-riwayat-nilai { position: absolute; left: 0; top: 0; width: 100%; }
        ...
        <div className="hidden print:block print:p-8 bg-white" id="print-rekap-nilai">
          ...
          <div className="mt-12 flex justify-end">
            <div className="text-center">
              ...
              <div className="h-20"></div>
              <p className="text-sm font-bold underline">{kepalaSekolahNama}</p>
              <p className="text-sm font-mono">NIP. {kepalaSekolahNip}</p>
            </div>
          </div>
        </div>
      )}
